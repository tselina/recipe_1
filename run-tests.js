...
const dataModelsPath = path.join(__dirname, 'js', 'data-models.js');
const dataModelsContent = fs.readFileSync(dataModelsPath, 'utf8');

// Create a module-like environment
const module = { exports: {} };
const window = {}; // Simulate browser environment

// Evaluate the data models in a way that exposes them globally
eval(dataModelsContent);

// Now the classes should be available globally
